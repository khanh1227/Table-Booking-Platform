...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    last_latitude = models.DecimalField(max_digits=12, decimal_places=9, null=True, blank=True)
    last_longitude = models.DecimalField(max_digits=12, decimal_places=9, null=True, blank=True)
    last_city = models.CharField(max_length=100, null=True, blank=True)
    last_district = models.CharField(max_length=100, null=True, blank=True)
