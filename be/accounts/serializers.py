...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'created_at', 'avatar_url', 'last_latitude', 'last_longitude', 
            'last_city', 'last_district'
        ]
...
class CustomerDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Customer
        fields = ['id', 'phone_number', 'email', 'full_name', 'date_of_birth', 'address', 'loyalty_points', 'total_bookings', 'credit_balance']
...
class PartnerDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Partner
        fields = ['id', 'phone_number', 'email', 'full_name', 'business_name', 'business_license', 'tax_code', 'status']
