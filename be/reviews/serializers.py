...
class ReviewReplySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'review', 'partner', 'created_at']
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Review
        fields = ['id', 'customer', 'customer_name', 'restaurant', 'restaurant_name', 'booking', 'rating', 'comment', 'image_url', 'reply', 'images', 'created_at', 'is_read_by_partner']
...
class ReviewReportSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        read_only_fields = ['id', 'review', 'partner', 'status', 'created_at']
