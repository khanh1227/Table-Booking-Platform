...
export default function TimeSlotForm({
    ...
    try {
      ...
      if (slot) {
        setFormData({
          ...
          max_guests_per_booking: slot.max_guests_per_booking?.toString() || '20',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.max_guests_per_booking)
        payload.max_guests_per_booking = Number(formData.max_guests_per_booking);
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              />
              <p className="text-xs text-slate-500 mt-1">Số lượng đơn đặt/slot</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-slate-900 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 outline-none transition"
              />
              <p className="text-xs text-slate-500 mt-1">Tối đa khách cho 1 đơn</p>
            </div>
          </div>
