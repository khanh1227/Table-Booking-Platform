...
import AdminPlatformRevenue from '@/components/admin/AdminPlatformRevenue';

type Section = 'dashboard' | 'approvals' | 'partners' | 'users' | 'marketing' | 'reviews' | 'platform-revenue';
...
export default function Admin() {
  ...
  const navItems = [
    ...
    { id: 'platform-revenue', label: 'THU NHẬP NỀN TẢNG', icon: Landmark, color: 'text-emerald-400' },
  ];
      ...
      <div className="flex-1 flex flex-col relative h-full overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto no-scrollbar p-6 lg:p-10 z-10 custom-scrollbar-main bg-slate-50/50">
          <div className="max-w-7xl mx-auto pb-20 animate-fadeIn">
            ...
            {currentSection === 'platform-revenue' && <AdminPlatformRevenue />}
          </div>
        </main>
      </div>
    </div>
